  ...
  <sharedSelectionEntries>
    ...
    <selectionEntry type="upgrade" import="true" name="Show/Hide Options" hidden="false" id="e8ef-836a-a9d1-901d">
      <entryLinks>
        ...
        <entryLink import="true" name="Show Nachmund Crusade" hidden="false" id="a60d-4971-6afe-b528" type="selectionEntry" targetId="16ff-b006-766a-5c2e"/>
      </entryLinks>
      <constraints>
    ...
    <selectionEntry type="upgrade" import="true" name="Show Nachmund Crusade" hidden="false" id="16ff-b006-766a-5c2e">
      <constraints>
        <constraint type="min" value="1" field="selections" scope="force" shared="true" id="302d-a312-b861-9720" includeChildSelections="false"/>
        <constraint type="min" value="1" field="selections" scope="parent" shared="true" id="1dc4-9bc0-825e-88bd" includeChildSelections="false"/>
      ...
      <modifiers>
        <modifier type="set" value="0" field="302d-a312-b861-9720"/>
        <modifier type="set" value="0" field="1dc4-9bc0-825e-88bd"/>
  ...
  <sharedSelectionEntryGroups>
          ...
          <selectionEntries>
            ...
            <selectionEntry type="upgrade" import="true" name="Gargantuan Rage" hidden="false" id="8a61-d218-94c9-0226">
              ...
              <modifierGroups>
                <modifierGroup type="and">
                  <modifiers>
                    <modifier type="append" value="Sustained Hits 1" field="name" affects="self.entries.profiles.Ranged Weapons" scope="upgrade" join=", ">
                      <conditions>
    ...
    <selectionEntryGroup name="Crusade Relics" id="e919-5b46-974d-a5b1" hidden="false">
      ...
      <selectionEntryGroups>
        ...
        <selectionEntryGroup name="Nachmund Relics" id="ee74-3f8c-ba66-cdcf" hidden="false">
          <selectionEntryGroups>
            <selectionEntryGroup name="Artificer Relics" id="e8dc-56d8-1ede-e4e4" hidden="false" sortIndex="1">
              <selectionEntries>
                <selectionEntry type="upgrade" import="true" name="Conversion Field" hidden="false" id="bca5-014a-c4a3-5e62">
                  <constraints>
                    <constraint type="max" value="1" field="selections" scope="parent" shared="true" id="5333-b903-682c-c76d"/>
                  </constraints>
                  <profiles>
                ...
                <selectionEntry type="upgrade" import="true" name="Gene-toxin Autofont" hidden="false" id="6cd8-250c-6522-65e6">
                  <constraints>
                    <constraint type="max" value="1" field="selections" scope="parent" shared="true" id="c4cc-8f82-f166-f2cf"/>
                  </constraints>
                  <profiles>
                ...
                <selectionEntry type="upgrade" import="true" name="Strategic Laurels" hidden="false" id="822e-ce82-21da-4f77">
                  <constraints>
                    <constraint type="max" value="1" field="selections" scope="parent" shared="true" id="2c58-58cd-39d0-aee3"/>
                  </constraints>
                  <profiles>
                ...
                <selectionEntry type="upgrade" import="true" name="Auto-medicae" hidden="false" id="4682-6d19-e410-234a">
                  <constraints>
                    <constraint type="max" value="1" field="selections" scope="parent" shared="true" id="8757-a1ae-0b43-d287"/>
                  </constraints>
                  <profiles>
            ...
            <selectionEntryGroup name="Antiquity Relics" id="0ce7-7335-f6a6-5c8d" hidden="false" sortIndex="2">
              <selectionEntries>
            ...
            <selectionEntryGroup name="Legendary Relics" id="e599-cab5-9365-a7de" hidden="false" sortIndex="3">
              <selectionEntries>
                <selectionEntry type="upgrade" import="true" name="Gloaming Mantle" hidden="false" id="82bb-501d-7153-2016">
                  <constraints>
                    <constraint type="max" value="1" field="selections" scope="parent" shared="true" id="47de-68ed-4869-a5cc"/>
                  </constraints>
                  <profiles>
                ...
                <selectionEntry type="upgrade" import="true" name="Lyreth&apos;s Mirror" hidden="false" id="a29b-536b-ec43-755f">
                  <constraints>
                    <constraint type="max" value="1" field="selections" scope="parent" shared="true" id="9e52-9031-bdcf-311e"/>
                  </constraints>
                  <profiles>
...
■ Declare a charge against that unit (note that even if this charge is successful, the bearer&apos;s unit does not receive any Charge bonus this turn).</characteristic>
                ...
                <selectionEntry type="upgrade" import="true" name="Fate-forged Weapon" hidden="false" id="5d0d-31d6-6e09-761a">
                  <constraints>
                    <constraint type="max" value="1" field="selections" scope="parent" shared="true" id="024a-10e4-0d5f-e1d6"/>
                  </constraints>
                  <profiles>
